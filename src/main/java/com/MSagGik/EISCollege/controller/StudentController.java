...
import com.MSagGik.EISCollege.entity.Faculty;
import com.MSagGik.EISCollege.entity.Student;
import com.MSagGik.EISCollege.entity.Class;
import com.MSagGik.EISCollege.mapper.StudentMapper;
import com.MSagGik.EISCollege.mapper.TeacherMapper;
...
public class StudentController {
    ...
    public String studentPage(Student student,Model model){
        ...
        s.setClassShortname(classController.getClassById(s.getClassNO()).getClassShortname()); // отражение группы в листе
        students.add(s);
    ...
    public String toTeacherList(Model model){
        ...
        for (Student student : studentList) {
            ...
            student.setClassShortname(classController.getClassById(student.getClassNO()).getClassShortname()); // отражение группы в листе
        }
